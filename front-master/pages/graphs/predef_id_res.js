...
class PredefIdPage extends Component {
    ...
    getData = () => {
        axios.get('http://localhost:8082/master/res/select_id_times')
        .then (res => {
                ...
                <body>
                    <div style={{backgroundColor: 'rgb(146, 239, 252)'}}>
                        ...
                        <p style={{marginLeft: "30px"}}> 
                            ...
                            Skripta koja je vršila upite je prvo generisla nasumični broj u opsegu domena primarnog ključa,<br /> 
                            a potom merila vreme odziva upita za generisanu vrednost. <br />
