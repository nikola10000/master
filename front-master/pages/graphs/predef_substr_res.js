...
class PredefSubstrPage extends Component {
    ...
    getData = () => {
        var idx; 
        axios.get('http://localhost:8082/master/res/select_substr_times')
        .then (res => {
        ...
        return (
            <html>
                ...
                <p style={{marginLeft: "30px"}}> 
                    <br />
                    Grafik prikazuje brzinu odziva upita selekcije na osnovu unapred definisanog podstringa. Skripta koja je <br />
                    vršila upite je sve podatke iz onih redova koji na odgovarajućim pozicijama unutar tekstualnog polja sadrže <br /> 
                    unapred zadati tekst. Indeks se formirao nad poljem čija se  vrednost gledala prilikom selekcije (ime). <br />
                    Primer upita: &emsp; <b style={{fontFamily: 'Courier'}}>{"SELECT * FROM radnik WHERE SUBSTR(ime, 3, 2) = 'ra'"}</b>
                </p>
                <div 
...
export default PredefSubstrPage