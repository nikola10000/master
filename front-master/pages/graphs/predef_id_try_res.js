...
class PredefIdPage extends Component {
    ...
    getData = () => {
        axios.get('http://localhost:8082/master/res/select_id_try_times')
        .then (res => {
                ...
                <body>
                    <div style={{backgroundColor: 'rgb(146, 239, 252)'}}>
                        ...
                        <p style={{marginLeft: "30px"}}> 
                            <br />
                            Grafik prikazuje brzinu odziva upita selekcije prema vrednosti primarnog ključa, <br />
                            ali za razliku od prethodnog primera ne postoji garancija pronalaženja vrednosti ključa <br /> 
                            u tabeli; verovatnoća da generisani ključ ne postoji u tabeli je 1 u 100.  <br />
                            Primer upita: &emsp; <b style={{fontFamily: 'Courier'}}>{'SELECT * FROM radnik WHERE mbr = 1'}</b>
                        </p>
                        <div 
