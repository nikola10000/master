...
class PredefMinPage extends Component {
    ...
    getData = () => {
        var idx; 
        axios.get('http://localhost:8082/master/res/select_min_times')
        .then (res => {
            ...
            <html>
                ...
                <body>
                    ...
                    <p style={{marginLeft: "30px"}}> 
                        <br />
                        Grafik prikazuje brzinu odziva upita selekcije na osnovu najmanje vrednosti brojevnog polja. Skripta koja ja vršila<br />
                        upite je dobavljala najmanju vrednost plate iz tabele. Indeks se formirao nad poljem čija se <br /> 
                        vrednost gledala prilikom selekcije (plt). <br />
                        Primer upita: &emsp; <b style={{fontFamily: 'Courier'}}>{'SELECT min(plt) FROM radnik'}</b>
                    </p>
                    <div 
