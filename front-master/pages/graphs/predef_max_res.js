...
class PredefMaxPage extends Component {
    ...
    getData = () => {
        var idx; 
        axios.get('http://localhost:8082/master/res/select_max_times')
        .then (res => {
    ...
    renderGraph (valuesNon, valuesTree, valuesBin) {
        let graph = {
        ...
        return (
            <html>
                ...
                <p style={{marginLeft: "30px"}}> 
                    <br />
                    Grafik prikazuje brzinu odziva upita selekcije na osnovu najveće vrednosti brojevnog polja. Skripta koja <br />
                    je vršila upite je dobavljala najveću vrednost plate iz tabele. Indeks se formirao nad poljem čija se <br /> 
                    vrednost gledala prilikom selekcije (plt). <br />
                    Primer upita: &emsp; <b style={{fontFamily: 'Courier'}}>{'SELECT max(plt) FROM radnik'}</b>
                </p>
                <div 
