                ...
                <body>
                    <div style={{backgroundColor: 'rgb(146, 239, 252)'}}>
                        ...
                        <p style={{marginLeft: "30px"}}> 
                            <br />
                            Grafik prikazuje brzinu odziva upita selekcije prema brojevnoj vrednosti manje od unapred zadate. Skripta koja ja vršila<br />
                            upite je dobavljala sve podatke iz svih redova u tabelema gde je plata manja od slučajno izabrane<br /> 
                            vrednosti. Indeks se formirao nad poljem čija sa vrednost gledala prilikom selekcije (plt). <br />
